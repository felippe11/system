...
def upgrade():
    ...
    with op.batch_alter_table('reviewer_application', schema=None) as batch_op:
        batch_op.alter_column('numero_revisores',
               existing_type=sa.INTEGER(),
               nullable=True,
               existing_server_default=sa.text('2'))
        batch_op.alter_column('modelo_blind',
...
def downgrade():
    ...
    op.create_table('evento_formulario',
    sa.Column('evento_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('formulario_id', sa.INTEGER(), autoincrement=False, nullable=False),
    ...
    op.create_table('formulario_evento_association',
    sa.Column('formulario_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('evento_id', sa.INTEGER(), autoincrement=False, nullable=False),
