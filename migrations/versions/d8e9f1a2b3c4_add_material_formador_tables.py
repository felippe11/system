...
def upgrade():
    ...
    def _has_columns(table_name, columns):
    ...
    if _has_columns('material_disponivel', ['cliente_id']):
        op.create_index('ix_material_disponivel_cliente_id', 'material_disponivel', ['cliente_id'])
    else:
        logger.warning("Skipping index ix_material_disponivel_cliente_id; column missing.")

    if _has_columns('material_disponivel', ['material_id']):
        op.create_index('ix_material_disponivel_material_id', 'material_disponivel', ['material_id'])
    else:
        logger.warning("Skipping index ix_material_disponivel_material_id; column missing.")

    if _has_columns('solicitacao_material_formador', ['formador_id']):
        op.create_index('ix_solicitacao_material_formador_formador_id', 'solicitacao_material_formador', ['formador_id'])
    else:
        logger.warning("Skipping index ix_solicitacao_material_formador_formador_id; column missing.")

    if _has_columns('solicitacao_material_formador', ['cliente_id']):
        op.create_index('ix_solicitacao_material_formador_cliente_id', 'solicitacao_material_formador', ['cliente_id'])
    else:
        logger.warning("Skipping index ix_solicitacao_material_formador_cliente_id; column missing.")

    if _has_columns('solicitacao_material_formador', ['status']):
        op.create_index('ix_solicitacao_material_formador_status', 'solicitacao_material_formador', ['status'])
    else:
        logger.warning("Skipping index ix_solicitacao_material_formador_status; column missing.")

    if _has_columns('solicitacao_material_formador', ['data_solicitacao']):
        op.create_index('ix_solicitacao_material_formador_data_solicitacao', 'solicitacao_material_formador', ['data_solicitacao'])
    else:
        logger.warning("Skipping index ix_solicitacao_material_formador_data_solicitacao; column missing.")
